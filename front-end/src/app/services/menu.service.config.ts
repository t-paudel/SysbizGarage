export const getLeftMenuData: any[] = [
...

  {
    ...
    children: [
      ...
      {
        key: 'Avail Compenstory Off',
        title: 'Avail Compenstory Off',
        url: '/leave/avail-comp-off',
      },
      {
        key: 'Notifications',
        title: 'Notifications',
      ...
      {
        key: 'Add New User Leave',
        title: 'Add New User Leave',
        url: '/leave/add-newuser-leaves',
      }, 
    ]
  }  
]
