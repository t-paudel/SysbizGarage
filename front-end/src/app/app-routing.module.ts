...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'employee',
        loadChildren: 'src/app/pages/employee/employee.module#EmployeeModule',
      },
      {
        path: 'blog',
      ...
      },
      {
        ...
        loadChildren: 'src/app/modules/leave-management/leave-management.module#LeaveManagementModule',
      },
      {
        path: 'leave',
        loadChildren: 'src/app/pages/leave/leave.module#LeaveModule',
      },
      {
        path: 'github',
      ...
      {
        path: 'process',
        loadChildren: 'src/app/pages/process/process.module#ProcessModule',
      },
